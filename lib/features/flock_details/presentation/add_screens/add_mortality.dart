...
class AddMortalityScreen extends StatefulWidget {
  const AddMortalityScreen({super.key, required this.flockModel});
            ...
            children: [
              ...
              Padding(
                ...
                child: CustomTextFormField(
                  controller: cubit.nomOfDead,
                  hintText: 'Number of dead',
                    ...
                    return PrimaryButton(
                        ...
                        pressAction: () async {
                          if (formKey.currentState!.validate()) {
                            cubit.createMortality(widget.flockModel.sId!);
                          }
                        });
                  },
                ),
